...
export function TitleBar() {
  ...
  const toggleWorkspaceTabPinned = useProjectsStore(
    (s) => s.toggleWorkspaceTabPinned,
  );
  const closeSavedWorkspaceTab = useProjectsStore(
    (s) => s.closeSavedWorkspaceTab,
  );
  const addWorkspaceTabToCurrent = useProjectsStore(
    (s) => s.addWorkspaceTabToCurrent,
  );
  ...
  const navigateWorkspaceHistory = useProjectsStore(
    (s) => s.navigateWorkspaceHistory,
  );
  const activeProfile =
