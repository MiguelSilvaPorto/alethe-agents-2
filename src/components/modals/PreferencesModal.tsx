        ...
        <div className={styles.choiceGrid}>
          {LOCALES.map((locale) => (
            <button
              ...
              type="button"
              className={
                preferences.language === locale.id
                  ? styles.choiceActive
                  : undefined
              }
      ...
      >
        <div className={styles.segmented}>
          <button
            type="button"
            className={
              preferences.showGitControl ? styles.segmentActive : undefined
            }
      ...
      >
        <select
          ...
          onChange={(event) =>
            setTerminalTheme(
              event.target.value
                ? (event.target.value as typeof preferences.uiTheme)
                : null,
            )
          }
        >
        ...
        <div className={styles.agentList}>
          {AGENTS.map((agent) => {
            ...
            return (
              <label
                key={agent.id}
                className={disabled ? styles.agentDisabled : undefined}
              >
                ...
                <input
                  ...
                  disabled={disabled}
                  onChange={(event) =>
                    setAgentEnabled(agent.id, event.target.checked)
                  }
                />
              </label>
            );
      ...
      >
        <div className={styles.segmented}>
          <button
            type="button"
            className={
              preferences.notifyOnLimitReset ? styles.segmentActive : undefined
            }
        ...
        >
          ...
          >
            <input
              ...
              onChange={(e) =>
                setPreferences({ nativeTerminalMacos: e.target.checked })
              }
            />
            <span style={{ flex: 1, fontSize: 13 }}>
              Habilitar terminal nativo (macOS)
            </span>
          </label>
        </SettingsSection>
      ) : null}
        ...
        <div className={styles.integrationFields}>
          <label>
            ...
            <input
              ...
              onChange={(event) =>
                setPreferences({ spotifyClientId: event.target.value })
              }
              spellCheck={false}
            />
          </label>
          <label>
            ...
            <input
              ...
              onChange={(event) =>
                setPreferences({ spotifyClientSecret: event.target.value })
              }
              spellCheck={false}
            />
          </label>
      ...
      >
        <div className={styles.segmented}>
          <button
            type="button"
            className={
              preferences.discordRichPresenceEnabled
